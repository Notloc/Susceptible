...
local Susceptible_spawnchance_hazmat = SandboxVars.Susceptible.SpawnChance * 0.2;
local Susceptible_spawnchance_military = SandboxVars.Susceptible.SpawnChance * 0.5;
local Susceptible_spawnchance_military_NBC = SandboxVars.Susceptible.SpawnChance * 0.4;
local Susceptible_spawnchance_survivor_medicalmask_blue = SandboxVars.Susceptible.SpawnChance * 0.8;
local Susceptible_spawnchance_survivor_medicalmask_green = SandboxVars.Susceptible.SpawnChance * 0.8;
local Susceptible_spawnchance_survivor_dustmask = SandboxVars.Susceptible.SpawnChance * 1;
local Susceptible_spawnchance_survivor_clothmask = SandboxVars.Susceptible.SpawnChance * 1;
